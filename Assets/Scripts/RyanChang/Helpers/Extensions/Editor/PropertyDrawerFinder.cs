/// From https://gist.github.com/wappenull/2391b3c23dd20ede74483d0da4cab3f1
/// Full credit to https://gist.github.com/wappenull
...
public static class PropertyDrawerFinder
{
    ...
    /// </summary>
    public static PropertyDrawer FindDrawer(SerializedProperty property)
    {
    ...
    static bool IsArrayPropertyPath(string[] fullPath, int i)
    {
    ...
    /// </summary>
    static bool IsListType(Type t, out Type containedType)
    {
